...
public class Client {
    ...
    public Client(UUID id, UUID userId, Integer version, String firstName, String lastName, String phoneNumber, String email, LocalDate dateOfBirth, String gender, String addressLine, String city, String postalCode, String country, Boolean isActive, String notes, Integer loyaltyPoints, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.userId = userId;
